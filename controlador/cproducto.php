<?php
	...
	*/
	if ($referencia && $descripcion && $tipo && $marca && $precio && $ubicacion && !$actu)
	{
		...
		$producto->insertar_producto($referencia,$newDescription,$tipo,$newBrand,$precio,$ubicacion);
	}
	/*
	...
	*/
	...
	{
		$producto->actualizar_producto($idcodedit,$referencia,$newDescription,$tipo,$newBrand,$precio,$ubicacion);
	}
	/*
