<?php
  ...
  $estado        = isset($_POST['estado']) ? $_POST['estado'] : NULL;
	...
	*/
	...
	{
		$empleado->insertar_empleado($idempleado,$newName,$newDir,$telefono,$email,$estado);
	}
	/*
	...
	*/
	...
	{
		$empleado->actualizar_empleado($idempleedit,$newName,$newDir,$telefono,$email,$estado);
	}
	/*
